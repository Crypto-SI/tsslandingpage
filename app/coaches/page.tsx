            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <AnimatedComponent animation="slideUp" delay={0.3}>
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-3">Development Focus</h3>
                  <p className="text-muted-foreground">
                    Player-centered approach focusing on technical skills, tactical understanding, and personal growth
                  </p>
                </div>
              </AnimatedComponent>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Coaching Team</h2>
                <p className="text-lg text-muted-foreground">
                  Meet our dedicated team of professional coaches
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {sortedCoaches.map((coach, index) => (
                  <AnimatedComponent key={coach.id} animation="slideUp" delay={index * 0.1}>
